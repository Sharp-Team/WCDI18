    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 function-row">
          <div class="mb-image">
            <img
              src="/images/homepage/iphone.jpg"
              alt="">
          </div>
        </div>
        <div class="col-md-6 function-row">
        ...
        <div class="row d-flex justify-content-center">
          <div class="wrap-img-profile">
            <a
              ...
              <div class="unhover_img">
                <img
                  src="/images/homepage/speaker-1.png"
                  alt="">
              </div>
              <div class="hover_img">
                <img
                  src="/images/homepage/speaker-1-hover.png"
                  alt="">
              </div>
          ...
          <div class="wrap-img-profile">
            <a
              ...
              <div class="unhover_img">
                <img
                  src="/images/homepage/speaker-3.png"
                  alt="">
              </div>
              <div class="hover_img">
                <img
                  src="/images/homepage/speaker-3-hover.png"
                  alt="">
              </div>
