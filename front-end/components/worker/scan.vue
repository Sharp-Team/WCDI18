<template>
  <div class="modal is-modal" id="scan-Modal">
      <div class="notification-content modal-content-1 ml-2" id="scan-ModalContent">
        <h6 class="notification-title">Quét <i class="fas fa-times is-IconClose" id="scanCloseModal"></i></h6>
