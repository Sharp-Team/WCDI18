        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              <div
                id="new-updates"
                class="card updates recent-updated">
                <div
                  id="updates-header"
                ...
                >
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <tr
                        v-for="(feedback, index) in listFeedBack"
                        :key="feedback.user">
